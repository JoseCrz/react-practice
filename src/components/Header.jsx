      ...
      <header className="Header">
        ...
        <nav className="Header__nav" id="menu">
            <ul className="Header__list">
                <li className="Header__list-item"><a href="#mapa" className="Header__link">Mapa</a></li>
                <li className="Header__list-item"><a href="#promociones" className="Header__link">Promociones</a></li>
                <li className="Header__list-item"><a href="#contacto" className="Header__link">Contacto</a></li>
